...
$output .= '<a href="#" id="close_search"><svg width="20" height="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
<polygon style="fill:#ccc;" points="21.1,0 12,9.2 2.8,0.1 0,2.9 9.2,12 0.1,21.2 2.9,24 12,14.8 21.2,23.9 24,21.1 14.8,12 23.9,2.8 "/>
</svg></a>';
...
if ($params->get('show_autosuggest', 1))
{
	...
	var suggest = jQuery('#mod-finder-searchword" . $module->id . "').autocomplete({
		...
		zIndex: 9999,
		deferRequestBy: 500,
		appendTo: 'div.finder-mod',
		onSelect: function(suggestion) { 
			console.log(suggestion.value);
			jQuery('input.search-query').val(suggestion.value);
