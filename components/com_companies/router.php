...
JLoader::registerPrefix('Companies', JPATH_SITE . '/components/com_companies/');
 ...
 * @since  3.3
 */
class CompaniesRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = CompaniesHelpersCompanies::getModel($view);
				if($model !== null){
	...
	public function parse(&$segments)
	{
		...
		$model        = CompaniesHelpersCompanies::getModel($vars['view']);
