...
JLoader::registerPrefix('People', JPATH_SITE . '/components/com_people/');
 ...
 * @since  3.3
 */
class PeopleRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = PeopleHelpersPeople::getModel($view);
				if($model !== null){
	...
	public function parse(&$segments)
	{
		...
		$model        = PeopleHelpersPeople::getModel($vars['view']);
