...
class PeopleViewPerson extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->params = $app->getParams('com_people');
	...
	protected function _prepareDocument()
	{
		...
		if ($menu)
		{
			...
			$this->params->def('page_heading', JText::_('COM_PEOPLE_DEFAULT_PAGE_TITLE'));
		}
		...
		$this->document->setMetadata('og_image', $this->item->hero);
	}
}
