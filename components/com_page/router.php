...
JLoader::registerPrefix('Page', JPATH_SITE . '/components/com_page/');
 ...
 * @since  3.3
 */
class PageRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = PageHelpersPage::getModel($view);
				if($model !== null){
	...
	public function parse(&$segments)
	{
		...
		$model        = PageHelpersPage::getModel($vars['view']);
