...
class TimelineModelItems extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_timeline'))
		{
	...
	/*protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_TIMELINE_SEARCH_FILTER_DATE_FORMAT"), "warning");
