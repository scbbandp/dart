...
JLoader::registerPrefix('Leadership', JPATH_SITE . '/components/com_leadership/');
 ...
 * @since  3.3
 */
class LeadershipRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = LeadershipHelpersLeadership::getModel($view);
				if($model !== null){
	...
	public function parse(&$segments)
	{
		...
		$model        = LeadershipHelpersLeadership::getModel($vars['view']);
