...
class FaqsViewQuestions extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo = FaqsHelper::getActions();

		JToolBarHelper::title(JText::_('COM_FAQS_TITLE_QUESTIONS'), 'questions.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_faqs&view=questions');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`question`' => JText::_('COM_FAQS_QUESTIONS_QUESTION'),
			'a.`category`' => JText::_('COM_FAQS_QUESTIONS_CATEGORY'),
		);
	}
