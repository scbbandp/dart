...
$document->addStyleSheet(JUri::root() . 'media/com_people/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_people&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="person-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PEOPLE_TITLE_PERSON', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('since'); ?>
				<?php echo $this->form->renderField('specialty'); ?>
				<?php echo $this->form->renderField('about'); ?>
				<?php echo $this->form->renderField('image'); ?>
				<?php echo $this->form->renderField('mobile'); ?>
				<?php echo $this->form->renderField('hero'); ?>
