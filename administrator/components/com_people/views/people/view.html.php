...
/**
 * View class for a list of People.
 *
 * @since  1.6
 */
class PeopleViewPeople extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		PeopleHelper::addSubmenu('people');
	...
	protected function addToolbar()
	{
		...
		$canDo = PeopleHelper::getActions();

		JToolBarHelper::title(JText::_('COM_PEOPLE_TITLE_PEOPLE'), 'people.png');
		...
		{
			JToolBarHelper::preferences('com_people');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_people&view=people');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_PEOPLE_PEOPLE_NAME'),
			'a.`job`' => JText::_('COM_PEOPLE_PEOPLE_JOB'),
			'a.`company`' => JText::_('COM_PEOPLE_PEOPLE_COMPANY'),
			'a.`since`' => JText::_('COM_PEOPLE_PEOPLE_SINCE'),
		);
	}
