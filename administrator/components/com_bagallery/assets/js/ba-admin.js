    ...
    $(document).ready(function(){
        ...
        if (categories) {
            ...
            categories.forEach(function(el, ind){
                ...
                str += '" data-id="';
                str += el.id+'" data-access="'+el.access+'"><a><label><i class="zmdi zmdi-folder">';
                str += '</i></label><span>';
        ...
        function listenMessage(event)
        {
            if (event.origin == location.origin) {
                ...
                if (uploadMode == 'images') {
                    ...
                    var pos = event.data.url.indexOf('/images/'),
                        img = event.data.url.substr(pos + 1);
