...
CREATE TABLE `#__bagallery_galleries` (
    ...
    `bg_active` varchar(40) NOT NULL,
    `bg_hover_active` varchar(40) NOT NULL,
    `border_color_active` varchar(40) NOT NULL,
    `font_color_active` varchar(40) NOT NULL,
    `font_color_hover_active` varchar(40) NOT NULL,
