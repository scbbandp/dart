...
JLoader::registerPrefix('Timeline', JPATH_COMPONENT_ADMINISTRATOR);
JLoader::register('TimelineHelper', JPATH_COMPONENT_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'timeline.php');
