...
class TimelineTableitem extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'TimelineTableitem', array('typeAlias' => 'com_timeline.item'));
		parent::__construct('#__timeline_', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_timeline.item.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_timeline/access.xml',
				"/access/section[@name='item']/"
			);
			$default_actions = JAccess::getAssetRules('com_timeline.item.' . $array['id'])->getData();
			$array_jaccess   = array();
