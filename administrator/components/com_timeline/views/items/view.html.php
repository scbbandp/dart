...
/**
 * View class for a list of Timeline.
 *
 * @since  1.6
 */
class TimelineViewItems extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		TimelineHelper::addSubmenu('items');
	...
	protected function addToolbar()
	{
		...
		$canDo = TimelineHelper::getActions();

		JToolBarHelper::title(JText::_('COM_TIMELINE_TITLE_ITEMS'), 'items.png');
		...
		{
			JToolBarHelper::preferences('com_timeline');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_timeline&view=items');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_TIMELINE_ITEMS_TITLE'),
		);
	}
