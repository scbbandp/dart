 ...
 * @since  1.6
 */
class TimelineViewItem extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TIMELINE_TITLE_ITEM'), 'item.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_timeline.item', $this->item->id);
		}
