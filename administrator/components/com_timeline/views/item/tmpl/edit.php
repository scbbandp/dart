...
$document->addStyleSheet(JUri::root() . 'media/com_timeline/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_timeline&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			<div class="span10 form-horizontal">
                ...
                <?php echo $this->form->renderField('date_text'); ?>
