...
/**
 * Smart Search adapter for com_page.
 *
 * @since  2.5
 */
class PlgFinderPages extends FinderIndexerAdapter
{
	/**
	...
	{
		// Make sure we're handling com_page categories.
		if ($extension === 'com_page')
		{
	...
	protected function getItemMenu($option, $view, $id)
	{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_page', true);
		...
		$menuItem = $this->getItemMenu('com_page', 'tpage', $item->id);
...
/*
			...
			$title = $menuItem->params->page_title;
			$summary = $menuItem->params->menu-meta_description;
	...
	protected function getListQuery($query = null)
	{
		...
		$query = $query instanceof JDatabaseQuery ? $query : $db->getQuery(true)
			->select("a.id, a.name, a.title, a.content AS body, a.alias, a.intro AS summary")
