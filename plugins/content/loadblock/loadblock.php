 ...
 * This uses the {loadblock} syntax
 *
 * @since  1.5
 */
class PlgContentLoadblock extends JPlugin
{
	...
	public function onContentPrepare($context, &$article, &$params, $page = 0)
	{
		...
		if (strpos($article->text, 'loadblock') === false)
		{
			return true;
		}
		...
		if ($matches)
		{
			foreach ($matches as $match)
			{
				...
				$output = $this->_loadmod($position, $style);
		...
		/*
		// Find all instances of plugin and put in $matchesmod for loadblock
